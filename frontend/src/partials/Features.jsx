...
import { FeaturesBg, FeaturesElement1, FeaturesElement2, FeaturesElement3 } from '../store/constants';
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">We Provide you with a suite of tools & Technology</p>
          </div>
